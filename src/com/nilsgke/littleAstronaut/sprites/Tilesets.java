...
public class Tilesets {
  ...
  // floors
  public static final ImageTileset grassFloor = new ImageTileset(
          "/assets/floors/grass/grass-repeating.png",
          "/assets/floors/grass/grass-end-left.png",
          "/assets/floors/grass/grass-end-right.png"
  );

  public static final ImageTileset desertFloor = new ImageTileset(
  ...
  public static final ImageTileset iceFloor = new ImageTileset(
          "/assets/floors/ice/ice-repeating.png",
          "/assets/floors/ice/ice-end-left.png",
          "/assets/floors/ice/ice-end-right.png"
  );

  public static final ImageTileset netherFloor = new ImageTileset(
